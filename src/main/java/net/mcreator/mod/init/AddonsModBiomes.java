...
import net.mcreator.mod.world.biome.PUPPYBiome;
import net.mcreator.mod.AddonsMod;
...
public class AddonsModBiomes {
	public static final DeferredRegister<Biome> REGISTRY = DeferredRegister.create(ForgeRegistries.BIOMES, AddonsMod.MODID);
	public static final RegistryObject<Biome> PUPPY = REGISTRY.register("puppy", () -> PUPPYBiome.createBiome());
